...
test('render g-link components', () => {
  ...
  expect($home('a[href="https://www.gridmix.github.io/docs"]').attr('target')).toBeUndefined()
  expect($home('a[href="https://www.gridmix.github.io/docs"]').attr('rel')).toBeUndefined()
